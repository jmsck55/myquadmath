...
rem echo Compiling for 32-bit WINBUILDS
rem set CPATH=C:\winbuilds32\lib\gcc\i686-w64-mingw32\4.8.3\include
rem set PATH=C:\winbuilds32\bin;%PATH%

echo Compiling for 64-bit WINBUILDS
set CPATH=C:\winbuilds64\lib64\gcc\x86_64-w64-mingw32\4.8.3\include
set PATH=C:\winbuilds64\bin;%PATH%
